...
Use Apache HttpClient 5 with one shared, closeable pooling client for the free
and premium provider adapters. Configure separate total/per-route connection
