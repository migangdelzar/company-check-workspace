...
| [0007](0007-gradle-paketo-and-immutable-compose.md) | Standardize build conventions, Paketo images, and digest-pinned Compose inputs | Partially superseded ([0009](0009-paketo-auto-resolution.md)) |
| [0008](0008-testcontainers-docker-context.md) | Make Testcontainers Docker endpoint and socket discovery explicit | Accepted |
| [0009](0009-paketo-auto-resolution.md) | Auto-resolve the Paketo builder/run image while keeping immutable Compose inputs | Accepted |
